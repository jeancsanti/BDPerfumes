...
cursor = banco.cursor()
cursor.execute("CREATE TABLE Perfumes (id integer, nome  varchar, quantidade integer, id_volume_FK integer, id_marca_FK integer, id_fixacao_FK integer)")
cursor.execute("CREATE TABLE Marcas (id integer, nome  varchar)")
